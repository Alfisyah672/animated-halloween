<template>
  <div>
    <video autoplay muted playsInline v-bind="camera" width="640" height="480" id="cam"
      style="position:fixed; top: 80px; left: 10px;" />

    <canvas id="c" width="640" height="480" style="position: fixed; top: 80px; left: 10px;" />
  </div>
</template>
